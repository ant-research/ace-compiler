...
#define OPCODE_IMPL_GEN_CR(NAME, name, kid_num, fld_num, prop)            \
  template <typename RETV, typename VISITOR>                              \
  RETV Handle_##name(VISITOR* visitor, air::opt::HCR_PTR node) {          \
    return _impl.template Handle_cr_##name<RETV, VISITOR>(visitor, node); \
  }

#define OPCODE_IMPL_GEN_SR(NAME, name, kid_num, fld_num, prop)            \
  template <typename RETV, typename VISITOR>                              \
  RETV Handle_##name(VISITOR* visitor, air::opt::HSTMT_PTR node) {        \
    return _impl.template Handle_sr_##name<RETV, VISITOR>(visitor, node); \
  }
...
#define OPCODE_DEFAULT_HANDLER_GEN(NAME, name, kid_num, fld_num, prop)     \
  template <typename RETV, typename VISITOR>                               \
  RETV Handle_##name(VISITOR* visitor, air::base::NODE_PTR node) {         \
...
#define OPCODE_DEFAULT_HANDLER_GEN_SR(NAME, name, kid_num, fld_num, prop) \
  template <typename RETV, typename VISITOR>                              \
  RETV Handle_sr_##name(VISITOR* visitor, air::opt::HSTMT_PTR node) {     \
    return visitor->Context().template Handle_sr<RETV, VISITOR>(visitor,  \
                                                                node);    \
  }

#define OPCODE_DEFAULT_HANDLER_GEN_CR(NAME, name, kid_num, fld_num, prop) \
  template <typename RETV, typename VISITOR>                              \
  RETV Handle_cr_##name(VISITOR* visitor, air::opt::HCR_PTR node) {       \
    return visitor->Context().template Handle_cr<RETV, VISITOR>(visitor,  \
                                                                node);    \
  }
...
#define OPCODE_CLONE_HANDLER_GEN(NAME, name, kid_num, fld_num, prop) \
  template <typename RETV, typename VISITOR>                         \
  RETV Handle_##name(VISITOR* visitor, air::base::NODE_PTR node) {   \
