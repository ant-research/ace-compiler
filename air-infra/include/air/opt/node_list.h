...
#ifndef AIR_OPT_NODE_LIST_H
#define AIR_OPT_NODE_LIST_H
...
public:
  ...
  void        Print() const { CMPLR_ASSERT(false, "TO IMPL Print"); }
  std::string To_str() const { CMPLR_ASSERT(false, "TO IMPL To_str"); }
