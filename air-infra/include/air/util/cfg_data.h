...
#define ENABLE_DOM_INFO()                                      \
  air::util::DOM_INFO        _dom_info;                        \
  air::util::DOM_INFO*       Dom_info() { return &_dom_info; } \
  const air::util::DOM_INFO* Dom_info() const { return &_dom_info; }

//! @brief define a macro to help integrate PDOM to user defined NODE_DATA
#define ENABLE_PDOM_INFO()                                       \
  air::util::DOM_INFO        _pdom_info;                         \
  air::util::DOM_INFO*       Pdom_info() { return &_pdom_info; } \
  const air::util::DOM_INFO* Pdom_info() const { return &_pdom_info; }
