...
class Torch(Frontend):
    ...
    def prepare(
        ...
        Args:
            ...
            library: Library name (antlib/phantom/hyperfhe)
        ...
        return TorchTracedModel(traced_model, input_names, input_shapes, output_shape, constants)
    ...
    def compile(
        ...
        """
        traced = self.prepare(model, inputs, input_names, library=library, device=device)
