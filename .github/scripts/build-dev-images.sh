...
#   TORCH_VERSIONS="2.5.0 2.6.0" ./.github/scripts/build-dev-images.sh
# ============================================================
...
TORCH_VERSIONS="${TORCH_VERSIONS:-2.5.0 2.6.0}"

# Version matrix: "base_image|dev_image|torch|torchvision|torchaudio"
declare -A VERSION_MAP=(
    ["2.5.0"]="ubuntu:22.04|ace/dev:ubuntu22.04|2.5.0|0.20.0|2.5.0"
    ["2.6.0"]="ubuntu:24.04|ace/dev:ubuntu24.04|2.6.0|0.21.0|2.6.0"
)
