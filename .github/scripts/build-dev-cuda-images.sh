...
#   CUDA_VERSIONS="cu124 cu130" ./.github/scripts/build-dev-cuda-images.sh
# ============================================================
...
CUDA_VERSIONS="${CUDA_VERSIONS:-cu128 cu130 cu131}"

# Version matrix: "base_image|dev_image|torch|torchvision|torchaudio|torch_index_url"
declare -A VERSION_MAP=(
    ["cu128"]="nvidia/cuda:12.8.0-devel-ubuntu24.04|ace/dev-cuda:12.8.0-devel-ubuntu24.04|2.11.0|0.26.0|2.11.0|https://download.pytorch.org/whl/cu128"
    ["cu130"]="nvidia/cuda:13.0.0-devel-ubuntu24.04|ace/dev-cuda:13.0.0-devel-ubuntu24.04|2.11.0|0.26.0|2.11.0|https://download.pytorch.org/whl/cu130"
    ["cu131"]="nvidia/cuda:13.1.0-devel-ubuntu24.04|ace/dev-cuda:13.1.0-devel-ubuntu24.04|2.11.0|0.26.0|2.11.0|https://download.pytorch.org/whl/cu130"
)
