...
public:
  ...
  bool Fuse_rule(OP_FUSION_RULE& cand, air::opt::HCR_PTR expr,
  ...
  uint64_t          Prec_key(air::opt::HCR_PTR encode_var);
  air::opt::HCR_PTR New_prec_var(air::opt::HCR_PTR encode_var);
  air::opt::HCR_PTR Prec_var(air::opt::HCR_PTR encode_var);
  air::opt::HCR_PTR Find_or_new_prec_var(air::opt::HCR_PTR encode_var);
...
private:
  ...
  std::map<uint64_t, air::opt::HCR_PTR>
      _prec_sym_map;  // [HCR_ID_VALUE, HCR_PTR]
};
