...
//! @brief Prepare input for FHE kernel program with data duplication filled
//! implemented in vendor library
...
CKKS_PARAMS* Get_context_params() __attribute__((weak));

//! @brief Optional extra CKKS context params from an auxiliary generated module.
//! When present, runtime merges its rotation indices into Get_context_params().
#if defined(__GNUC__)
CKKS_PARAMS* Get_extra_context_params() __attribute__((weak));
#else
CKKS_PARAMS* Get_extra_context_params();
#endif

//! @brief Get seperated weight data file info
//! generated by fhe-cmplr
RT_DATA_INFO* Get_rt_data_info() __attribute__((weak));

//! @brief Return number of input parameters
//! generated by fhe-cmplr
int Get_input_count() __attribute__((weak));

//! @brief Return number of output parameters
//! generated by fhe-cmplr
int Get_output_count() __attribute__((weak));

//! @brief Return scheme to guide pre encoding from tensor to ciphertext
//! generated by fhe-cmplr
DATA_SCHEME* Get_encode_scheme(int idx) __attribute__((weak));

//! @brief Return scheme to guide post decoding from ciphertext to tensor
//! generated by fhe-cmplr
DATA_SCHEME* Get_decode_scheme(int idx) __attribute__((weak));

//! @brief Main graph from FHE compiler
//! generated by fhe-cmplr
bool Main_graph() __attribute__((weak));
