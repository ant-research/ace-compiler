...
//! @brief Transform complex message to plaintext space by canonical embedding
//! inverse
//! @return return true if value within range, false otherwise
bool Transform_msg_within_range(VALUE_LIST* res, CKKS_ENCODER* encoder,
                                VALUE_LIST* msg, uint32_t level, double scale);
