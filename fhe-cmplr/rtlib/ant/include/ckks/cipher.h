...
//! @brief Initialize ciphertext from ciph & scalars
//! @param len length of scalars
...
//! @brief Initialize ciphertext3 from ciph with scale down,
//! which is used for rescale()
...
//! @brief Verify the value range of msg according to the encoded msg at ciph's
//! level
...
//! @brief Print message by block length obtained by decrypt & decode ciphertext
