...
#include "bit_operation_impl.h"
#include "common/rtlib_timing.h"
#include "common/trace.h"
#include "hal/ntt_math.h"
#include "ntt_impl.h"
#include "number_theory_impl.h"
#include "type_impl.h"

//! @brief Seal equivalent NTT implementation
void Transform_to_rev(VALUE_LIST* input, NTT_CONTEXT* ntt, VALUE_LIST* rou);
//! @brief Seal equivalent INTT implementation
...
#ifdef ENABLE_HPU_2DNTT
  int64_t root = Find_2nth_root(poly_degree, coeff_modulus->_val);
#else
