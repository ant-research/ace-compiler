...
namespace fhe {
namespace poly {
extern const POLY_FUNC_INFO* Poly_func_info(fhe::core::FHE_FUNC func_id);
}  // namespace poly
}  // namespace fhe
...
protected:
  TEST_CKKS2POLY() : _ckks_ir_gen(_fhe_ctx) {}
...
private:
  POLY_CONFIG        _poly_config;
  LOWER_CTX          _fhe_ctx;
  CKKS_IR_GEN        _ckks_ir_gen;
  CKKS2POLY_CTX*     _ctx;
...
TEST(POLY_IR_GEN, Builtin_func) {
  const POLY_FUNC_INFO* rotate_func = Poly_func_info(fhe::core::ROTATE);
  EXPECT_TRUE(rotate_func != nullptr);
  EXPECT_EQ(rotate_func->_func_id, fhe::core::ROTATE);
