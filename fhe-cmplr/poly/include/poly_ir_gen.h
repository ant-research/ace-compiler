...
public:
  ...
  air::base::ADDR_DATUM_PTR New_polys_var(const SPOS& spos);
  ...
  CONST_VAR& Add_node_var(NODE_PTR node, air::base::ADDR_DATUM_PTR sym,
                          FIELD_PTR fld = air::base::Null_ptr) {
  ...
  CONST_VAR& Node_var(NODE_PTR node) {
    ...
    } else if (Lower_ctx()->Is_poly_type(node->Rtype_id())) {
  ...
  NODE_PTR New_poly_mul(NODE_PTR opnd1, NODE_PTR opnd2, const SPOS& spos);

  NODE_PTR New_poly_rotate(NODE_PTR opnd1, NODE_PTR opnd2, const SPOS& spos);
  ...
  STMT_PTR New_plain_poly_store(CONST_VAR v_plain, NODE_PTR node, bool is_rns,
                                const SPOS& spos);
  ...
  STMT_PTR New_init_poly(CONST_VAR v_res, NODE_PTR node, bool ext = false);
  STMT_PTR New_init_poly(NODE_PTR n_res, NODE_PTR n_opnd1, NODE_PTR n_opnd2,
                         bool ext, const SPOS& spos);

  STMT_PTR New_check_level(CONST_VAR v_res, NODE_PTR node);
  STMT_PTR New_check_level(NODE_PTR n_res, NODE_PTR n_opnd1, NODE_PTR n_opnd2,
                           const SPOS& spos);
  /**
  ...
  NODE_PTR New_modswitch(NODE_PTR n_opnd, const SPOS& spos);
  ...
  NODE_PTR New_precomp(NODE_PTR node, const SPOS& spos);

  NODE_PTR New_dot_prod(NODE_PTR n1, NODE_PTR n2, NODE_PTR n3,
                        const SPOS& spos);
  ...
  NODE_PTR New_swk_c0(bool is_rot, const SPOS& spos,
                      NODE_PTR n_rot_idx = air::base::Null_ptr);

  NODE_PTR New_swk_c1(bool is_rot, const SPOS& spos,
                      NODE_PTR n_rot_idx = air::base::Null_ptr);
  /**
  ...
  STMT_PTR New_adjust_p_idx(const SPOS& spos);
  ...
  void Set_mul_ciph(NODE_PTR node);
