...
public:
  ...
  POLY_LOWER_RETV Handle_lower_retv(NODE_PTR n_node, NODE_PTR n_parent);
...
private:
  POLY_LOWER_RETV Handle_add_ciph(CKKS2POLY_CTX& ctx, NODE_PTR node,
                                  POLY_LOWER_RETV opnd0_pair,
                                  POLY_LOWER_RETV opnd1_pair);

  POLY_LOWER_RETV Handle_add_plain(CKKS2POLY_CTX& ctx, NODE_PTR node,
                                   POLY_LOWER_RETV opnd0_pair,
                                   POLY_LOWER_RETV opnd1_pair);

  POLY_LOWER_RETV Handle_add_float(CKKS2POLY_CTX& ctx, NODE_PTR node,
                                   POLY_LOWER_RETV opnd0_pair,
                                   POLY_LOWER_RETV opnd1_pair);

  POLY_LOWER_RETV Handle_mul_ciph(CKKS2POLY_CTX& ctx, NODE_PTR node,
                                  POLY_LOWER_RETV opnd0_pair,
                                  POLY_LOWER_RETV opnd1_pair);

  POLY_LOWER_RETV Handle_mul_plain(CKKS2POLY_CTX& ctx, NODE_PTR node,
                                   POLY_LOWER_RETV opnd0_pair,
                                   POLY_LOWER_RETV opnd1_pair);

  POLY_LOWER_RETV Handle_mul_float(CKKS2POLY_CTX& ctx, NODE_PTR node,
                                   POLY_LOWER_RETV opnd0_pair,
                                   POLY_LOWER_RETV opnd1_pair);
  ...
  FUNC_SCOPE* Gen_rotate_func(CKKS2POLY_CTX& ctx, NODE_PTR node,
                              const SPOS& spos);
  ...
  FUNC_SCOPE* Gen_relin_func(CKKS2POLY_CTX& ctx, NODE_PTR node,
                             const SPOS& spos);
...
template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CKKS2POLY::Handle_encode(VISITOR* visitor, NODE_PTR node) {
  SPOS           spos     = node->Spos();
...
template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CKKS2POLY::Handle_add(VISITOR* visitor, NODE_PTR node) {
...
template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CKKS2POLY::Handle_mul(VISITOR* visitor, NODE_PTR node) {
  POLY_LOWER_RETV       retv;
  CKKS2POLY_CTX&        ctx             = visitor->Context();
  fhe::core::LOWER_CTX* lower_ctx       = ctx.Lower_ctx();
  bool                  is_gen_rns_loop = Pre_handle_ckks_op(visitor, node);
...
template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CKKS2POLY::Handle_relin(VISITOR* visitor, NODE_PTR node) {
  CKKS2POLY_CTX& ctx  = visitor->Context();
...
template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CKKS2POLY::Handle_rotate(VISITOR* visitor, NODE_PTR node) {
  CKKS2POLY_CTX& ctx  = visitor->Context();
  CONTAINER*     cntr = ctx.Container();
  SPOS           spos = node->Spos();
...
template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CKKS2POLY::Handle_rescale(VISITOR* visitor, NODE_PTR node) {
  CKKS2POLY_CTX&        ctx             = visitor->Context();
  fhe::core::LOWER_CTX* lower_ctx       = ctx.Lower_ctx();
  bool                  is_gen_rns_loop = Pre_handle_ckks_op(visitor, node);
...
//! @brief Handle CKKS_OPERATOR::MODSWITCH
template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CKKS2POLY::Handle_modswitch(VISITOR* visitor, NODE_PTR node) {
  CKKS2POLY_CTX&        ctx             = visitor->Context();
  fhe::core::LOWER_CTX* lower_ctx       = ctx.Lower_ctx();
  bool                  is_gen_rns_loop = Pre_handle_ckks_op(visitor, node);
  NODE_PTR              opnd0           = node->Child(0);
...
template <typename VISITOR>
POLY_LOWER_RETV CKKS2POLY::Post_handle_ckks_op(VISITOR* visitor, NODE_PTR node,
                                               POLY_LOWER_RETV rhs,
                                               bool is_gen_rns_loop) {
  POLY_LOWER_RETV retv;
  CKKS2POLY_CTX&  ctx      = visitor->Context();
...
template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CORE2POLY::Handle_ld(VISITOR* visitor, NODE_PTR node) {
  return Handle_ld_var(visitor, node);
}

template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CORE2POLY::Handle_ldp(VISITOR* visitor, NODE_PTR node) {
  return Handle_ld_var(visitor, node);
}

template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CORE2POLY::Handle_ild(VISITOR* visitor, NODE_PTR node) {
  CKKS2POLY_CTX&  ctx  = visitor->Context();
...
template <typename VISITOR>
POLY_LOWER_RETV CORE2POLY::Handle_ld_var(VISITOR* visitor, NODE_PTR node) {
...
template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CORE2POLY::Handle_st(VISITOR* visitor, NODE_PTR node) {
  CKKS2POLY_CTX& ctx = visitor->Context();
...
template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CORE2POLY::Handle_stp(VISITOR* visitor, NODE_PTR node) {
  CKKS2POLY_CTX& ctx = visitor->Context();
  if (!(node->Child(0)->Is_ld())) {
...
template <typename VISITOR>
POLY_LOWER_RETV CORE2POLY::Handle_st_var(VISITOR* visitor, NODE_PTR node,
                                         CONST_VAR var) {
...
template <typename RETV, typename VISITOR>
POLY_LOWER_RETV CORE2POLY::Handle_retv(VISITOR* visitor, NODE_PTR node) {
  CKKS2POLY_CTX& ctx     = visitor->Context();
  NODE_PTR       n_opnd0 = node->Child(0);
