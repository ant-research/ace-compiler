...
static OPTION_DESC Poly2c_option[] = {
    ...
    {"ctp",      "compile-time precompute",
                             "Precompute for Encode plaintext at compile-time",                                               &Poly2c_config._ct_prec,
                             air::util::K_NONE,                                                                                                                             0, V_NONE },
    {"fp",       "free_poly",
                             "Insert Free_poly right after the last use of the poly or poly in cipher",
                             &Poly2c_config._free_poly,                                                                                                air::util::K_NONE,   0, V_NONE },
    {"df_limit", "df_limit",                "Data file size limit in megabytes",
                             &Poly2c_config._df_limit,                                                                                                 air::util::K_UINT64, 0, V_EQUAL},
};
