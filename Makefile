...
.PHONY: all build install clean test help configure rebuild setup-deps verify verify-quick verify-functional
...
test-unit:
	...
	@$(PYTHON) -m pytest tests/test_unit/ -v --tb=short -q

test-frontend:
	@echo -e "$(BLUE)Running frontend tests...$(NC)"
	@$(PYTHON) -m pytest tests/test_unit/test_frontend/ -v --tb=short -q

test-regression:
	@echo -e "$(BLUE)Running regression tests...$(NC)"
	@$(PYTHON) -m pytest tests/test_regression/ -v --tb=short -q
...
help:
	@echo "ANT-ACE Development Makefile"
	@echo ""
