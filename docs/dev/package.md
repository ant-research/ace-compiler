...
# GPU with HyperFHE backend
ENABLE_LIB="hyperfhe" pip wheel . -w dist/

# Multiple backends
ENABLE_LIB="hyperfhe;phantom" pip wheel . -w dist/
...
│   ├── runtime/             # Runtime
│   └── util.py              # Utilities
├── models/                  # Model weights (e.g., ResNet)
...
│   └── libFHErt_hyperfhe.so # HyperFHE GPU runtime
...
Version is defined in `fhe_dsl/ace/_version.py`:
