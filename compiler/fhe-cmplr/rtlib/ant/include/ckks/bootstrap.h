...
//! @brief Upper bound for the number of overflows in the sparse secret case
#define K_SPARSE 14

//! @brief Number of double-angle iterations in CKKS bootstrapping.  Must be
...
//! @brief Number of double-angle iterations in CKKS bootstrapping.  Must be
//! static because it is used in a static function.
#define R_UNIFORM_HW_192 3

//! @brief Upper bound for the number of overflows in the uniform secret case
#define K_UNIFORM_HW_192 32

//! @brief Chebyshev series coefficients for the OPTIMIZED/uniform case
...
//! @brief Number of double-angle iterations in CKKS bootstrapping.  Must be
//! static because it is used in a static function.
#define R_UNIFORM_EVEN_HW_192 3

//! @brief Upper bound for the number of overflows in the uniform secret case
//! Chebyshev series coefficients for the OPTIMIZED/uniform case
#define K_UNIFORM_EVEN_HW_192 32
...
//! @brief Number of double-angle iterations in CKKS bootstrapping.  Must be
//! static because it is used in a static function.
#define R_UNIFORM_EVEN 7

//! @brief Upper bound for the number of overflows in the uniform secret case
#define K_UNIFORM_EVEN 512
...
static inline uint32_t Get_bootstrap_depth(VALUE_LIST* level_budget,
  ...
  return approx_depth + encode_budget + decode_budget;
}
...
typedef struct {
  ...
  VL_VL_PLAIN* _u0_pre_fft;  //!< coeffs corresponding to U0(decoding)
  VL_VL_PLAIN*
       _u0hatt_pre_fft;  //!< coeffs corresponding to conj(U0^T)(encoding)
  bool _keygen_status;   //!< Set true if keys were generated, default is false
} CKKS_BTS_PRECOM;
