...
#ifndef FHE_CKKS_CKKS2C_MFREE_H
#define FHE_CKKS_CKKS2C_MFREE_H
...
//! @brief Utility to help insert Free_cipher
class MFREE_UTIL {
public:
...
private:
  ...
  void Append_free_stmt(air::base::NODE_PTR var) {
    ...
    air::base::STMT_PTR stmt =
        Container()->New_cust_stmt(fhe::ckks::OPC_FREE, Spos());
...
//! @brief Pass to analyze and insert Free_cipher
class MFREE_PASS {
public:
